                            ...
                            <tbody>
                                ...
                                foreach ($data as $a) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="remove.php?id=<?php echo $a['lid']; ?>"><button class="btn btn-danger">Revoke access</button></a></td>
                                        </tr>
                                <?php } }
                                else{ ?>
                                    <tr><span class="badge badge-pill badge-danger mt-5 mx-1">There are no lawyers </span></tr>
